...
tckUtil.generateMochaSuite(path.resolve(tckUtil.projectFolder(), "src/raml1/test/data/parser/UnfoldTypes"), path.resolve(tckUtil.projectFolder(), "src/raml1/test/unfoldTypes.ts"), dataRoot, 'Types Unfolding Tests', false, true, true);
