...
function testAPIScript(o) {
    return doTestAPI(o.apiPath, o.extensions, o.tckJsonPath, o.newFormat, o.regenerteJSON, true, true, o.expandLib, o.unfoldTypes);
}
...
function doTestAPI(apiPath, extensions, tckJsonPath, newFormat, regenerteJSON, callTests, doAssert, expandLib, unfoldTypes) {
